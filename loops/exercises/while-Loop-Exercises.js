...
//b. Use a second loop to query the user for the number of astronauts (up to a maximum of 7). Validate the entry.
  while (numAstronauts <= 7 && numAstronauts >= 0 ){
    numAstronauts = input.question("Enter the amount of astronauts on board: ")
  }
  while (numAstronauts > 7 || numAstronauts < 0) {
    numAstronauts = input.question("Invalid Input, please enter a valid number of astronauts: ")
  }
